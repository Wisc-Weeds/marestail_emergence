...
#  geom_point(alpha = 0.1) +
  ...
  theme(axis.title = element_markdown(size = 12),
        ...
        strip.text = element_markdown(size = 11, face = "bold")) -> fig3
...
cld_1 %>%
  ...
  geom_text_repel(aes(label = round(rate,0), 
                    ...
                    seed = 455) +
  geom_text(aes(x = population, y = upper.CL + 35, label = .group),
            inherit.aes = FALSE) +
  scale_color_colorblind(name = NULL) +
#  facet_grid(~ ed, switch = "y") +
  ...
  theme(legend.position = "none",
        ...
        axis.text = element_markdown(size = 11)) -> fig2

#ggsave("figures/fig_2.png", dpi = 300, width = 4, height = 7)
```
Só não entendi a piada da Unoeste. 
