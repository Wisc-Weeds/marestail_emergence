...
#  scale_color_brewer(name = NULL, palette = "Set1") +
  ...
  theme(axis.title = element_markdown(size = 10),
        ...
        legend.text = element_text(size = 5),
        legend.key.size = unit(0.3, "cm")) -> fig4
...
wd_sct %>% 
  ...
  geom_bar(aes(x = date, y = precip, 
           ...
           fill = "grey10",
           show.legend = FALSE) +
  annotate("text", x=as.Date("2016-08-30"), y = 60, 
           label = "Precipitation",
           size = 2, color = "grey10") +
  annotate("text", x=as.Date("2017-07-15"), y = 80, 
           label = "Mean\n air temperature",
           size = 2, color = "blue") +
  annotate("text", x=as.Date("2017-01-15"), y = 150, 
           label = "Mean soil temperature",
           size = 2, color = "firebrick") +
  labs(x = NULL) +
  theme(legend.position = "none",
        axis.title = element_markdown(size = 10),
        axis.text = element_markdown(size = 9)) -> temp
