...
readxl::read_excel("anova.xlsx", sheet = "Lin") %>% 
  ...
  mutate(trt = case_when(
    ...
    pop == "L" & crop == "corn" ~ "Lin1 in corn",
    pop == "L" & crop == "soy" ~ "Lin1 in soybean",
    pop == "NP" & crop == "corn" ~ "Npl1 in corn",
    pop == "NP" & crop == "soy" ~ "Npl1 in soybean",
    pop == "SB" & crop == "corn" ~ "Scb1 in corn",
    pop == "SB" & crop == "soy" ~ "Scb1 in soybean",
    TRUE ~ NA_character_
  )) %>% 
...
cld3 %>% 
  ...
  labs(x = NULL, 
       y = expression(paste("Horseweed density (plants m"^"2",")")),
       shape = NULL) +
...
ggplot(aes(x = GDD, y = emergence > 0, 
           color = trt)) + 
  coord_trans(x= "log") +
