...
ed1 %>% 
  ...
  ed == "90" ~ "90% emergence",
  TRUE ~ "ed")) %>% 
  mutate(trt = fct_relevel(trt, levels = c("Lin1 in irrigated",
                                           "Scb1 in fallow",
                                           "Lin1 in fallow",
                                           "Npl1 in fallow",
                                           "Npl1 in irrigated",
                                           "Scb1 in irrigated"))) -> ed2
```
...
cld_1 %>% 
  ...
  labs(x = NULL, y = expression(paste("Horseweed density (plants m"^"2",")"))) +
...
scottsbluff %>% 
    mutate(trt = fct_relevel(trt, levels = c("Lin1 in irrigated",
                                           ...
                                           "Npl1 in fallow",
                                           "Npl1 in irrigated",
                                           "Scb1 in irrigated"))) -> scottsbluff1
